...
Format the scores at the top as a clear list, then provide the narrative.`;
  ...
  if (phase === 'briefing') {
    return <ScenarioBriefing scenario={scenario} onLaunch={handleLaunch} industry={industry} />;
  }
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bg-primary)' }}>
      ...
      <AIAdvisorConsole scenario={scenario} simulationMessages={messages} industry={industry} />
    </div>
  );
}
