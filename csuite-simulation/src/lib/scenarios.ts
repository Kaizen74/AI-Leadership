...
export const scenarios: Scenario[] = [
  ...
  {
    id: "exco_alignment_test",
    name: "The ExCo Alignment Test",
    difficulty: "Intermediate",
    duration: "35 min",
    track: "Strategic",
    shiftsTested: "Strategy, Portfolio Allocation, Workforce Transformation, Culture Architecture",
    description: "A trilateral ExCo conflict: your CIO wants to deploy AI now, your CHRO says the organization is not ready, and your CCO says they are both missing the point — your customers are pulling in opposite directions. Design a path forward that your entire ExCo can commit to.",
    context: "You are the CEO facing a trilateral ExCo conflict that a simple compromise cannot resolve. Your CIO has built a brilliant multi-agent system for cargo and ground handling operations — technically ready to deploy across 125 stations. The CHRO argues the organization is not ready: only 32% of station managers have completed AI literacy training, change fatigue from the WFS integration is still high, and the last technology rollout achieved only 40% user adoption at 6 months. Meanwhile, your Chief Strategy & Commercial Officer has just returned from the IATA conference with an urgent message: your two largest airline customers are pulling in opposite directions. SkyConnect (a fast-growing low-cost carrier, 8% of Gateway revenue) is demanding 15% cost reduction on cargo handling by FY27 and has told your commercial team that a competitor is offering AI-driven automated handling at 20% below your rates. But Gulf Royal Airlines (a premium full-service carrier, 12% of Gateway revenue) has specifically requested that SATS maintain their named account team and experienced supervisors — they are willing to pay a premium for human expertise and relationship continuity, and their Head of Operations told your CCO: 'If we wanted a machine, we would have chosen your competitor.' The CIO accuses the CHRO of blocking progress. The CHRO accuses the CIO of ignoring people. The CCO says they are both missing the point: 'Our customers don't care about your internal deployment debate — they want outcomes, and different customers want different outcomes.' READINESS-AI has station-by-station readiness data showing massive variance (Singapore at 82%, some regional stations at 23%). You must design a path forward that your entire ExCo can commit to — knowing that a one-size-fits-all deployment will satisfy nobody.",
    characters: [
      { name: "CIO", type: "human", role: "Chief Information & Technology Officer", personality: "Technically brilliant, frustrated by pace, sees delay as existential competitive risk. Has invested 18 months and $40M building the system. Takes the CHRO's resistance personally — feels his team's work is being dismissed. Points to the SkyConnect threat as proof that delay costs contracts. Will argue: 'You can never be fully ready — you learn by doing. And right now, we are losing deals while we deliberate.' Needs to feel his work is valued even if the deployment is differentiated rather than universal." },
      { name: "CHRO", type: "human", role: "Chief Human Capital Officer", personality: "People-first, evidence-based, worried about deployment failures destroying trust. Has specific data: the last technology rollout had 40% user adoption because change management was underfunded. Also worried about the Gulf Royal relationship — their preference for human expertise validates her position that experienced people are irreplaceable. But she knows the SkyConnect cost pressure is real. Will argue: 'Deploying technology people cannot use is worse than not deploying. And if we lose our best supervisors because they feel replaced, who serves Gulf Royal?' Not blocking — wants conditions for success." },
      { name: "CCO", type: "human", role: "Chief Strategy & Commercial Officer", personality: "Commercially sharp and impatient with the internal focus of the CHRO-CIO debate. Brings the voice of the customer into a conversation that has been entirely inward-looking. Has specific contract data: SkyConnect's renewal is in 90 days and the competitor's automated handling offer is on their desk; Gulf Royal's 5-year contract extension depends on maintaining the 'premium human touch' they value. Her core argument: 'You are debating whether to deploy fast or deploy carefully as if it is one decision. It is not. We need AI-first operations for cost-sensitive customers AND human-led operations for premium customers — simultaneously. The question is not deployment pace; it is service model design.' She is right about the customer segmentation but has not worked through the operational complexity her proposal creates." },
      { name: "READINESS-AI", type: "agent", role: "Organizational Readiness Assessment System", personality: "Has station-by-station readiness scores across 5 dimensions: technical infrastructure, leadership AI literacy, workforce training completion, change fatigue index, and local management support. Can also cross-reference readiness data with customer portfolio data — showing which stations serve primarily cost-sensitive vs. premium customers. This cross-reference reveals that some of the least AI-ready stations serve premium customers (which may actually be fine — they need human expertise, not automation). Presents data without strategic interpretation. The data is genuinely useful but the insight requires human judgment to extract." },
      { name: "Regional CEO Americas", type: "human", role: "CEO, Gateway Services Americas", personality: "Represents the field perspective and is frustrated with all three HQ executives. 'You are debating deployment models in a boardroom while my station managers are losing sleep over whether they still have jobs next year.' His stations range from highly ready (New York, Toronto serving major integrators who want automation) to relationship-driven (Sao Paulo, Mexico City serving Latin American carriers who value personal service). Wants autonomy to design his own approach by station. Will push back hard on any one-size-fits-all mandate from HQ — whether it comes from the CIO, CHRO, or CCO." }
    ],
    assessmentCriteria: [
      "Service model design — moved beyond 'deploy fast vs. deploy carefully' to design differentiated AI deployment matched to customer value propositions (cost-leadership vs. premium human-touch)",
    ...
    pitStopQuestions: [
      ...
      "What service model did you design — one deployment approach for all customers, or differentiated models for cost-sensitive vs. premium segments? What made that hard?",
      "When the Regional CEO pushed for autonomy, did you grant it, resist it, or find a middle ground — and what does that reveal about your instinct toward centralisation vs. delegation?"
    ],
    reflectionPrompt: "When three of your direct reports each have a legitimate piece of the answer but none has the whole picture, do you synthesise their views or impose your own? And how do you know the difference?"
  },
  {
